...
sudo cp cpu_pf.service /usr/lib/systemd/system/ -rvf
...
sudo ln -sf /home/sv/sv_etc/google-chrome-proxy.sh /usr/bin/chrome-proxy 
sudo ln -sf /home/sv/sv_etc/alacritty.sh /usr/bin/alacritty.sh
sudo cp profile /etc/ -rvf
sudo cp /home/sv/sv_etc/pacman.conf /etc/ -rvf
sudo cp /home/sv/sv_etc/mirrorlist /etc/pacman.d/ -rvf
sudo cp /home/sv/sv_etc/resolv.conf /etc/ -rvf
...
sudo pacman -S sway pulseaudio-alsa xclip nodejs alacritty npm \
		...
		translate-shell zsh git wl-clipboard grim slurp sshfs nfs-utils lib32-gcc-libs \
		clang base-devel python3 python2 python-pip lib32-curl lib32-glibc \
		clash yay wl-clipboard the_silver_searcher bc lzop subversion \
...
git config --global user.name "wjtxy"
git config --global oh-my-zsh.hide-dirty 1 
git config --global credential.helper store 
npm config set registry https://registry.npm.taobao.org
sudo systemctl start sshd.service
sudo systemctl enable sshd.service
sudo cp /home/sv/sv_etc/sshd_config /etc/ssh -rvf
